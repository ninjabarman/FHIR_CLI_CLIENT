...
namespace FHIR_CLI_Client.Services
{
    public class PatientService
    {
        ...
        public IEnumerable<Patient> GetAllPatients()
        {
            ...
            while(patientsExist)
            {
                try
                {
                    string url = ConfigurationManager.AppSettings["SparkServerURI"] + "/Patient/" + i.ToString();
